      ...
      <div className="content-block">
        ...
        <div className="text">
          ...
          <p>
            ...
            actual wall-mounted scanners that scans patients’ QR codes. This
            mobile app is to be used by as many users as possible, hence it has
            to be cross-platform. We also have to consider the amount of time
            and resources that we have, and developing a full native app will
            most likely not be possible, which leads to the idea of building a
            hybrid app. The next part discusses the costs and benefits between
            hybrid and native app building, and tries to conclude that a hybrid
            app is the right choice for us. Moving on to the app development
            itself, there are mainly 2 options: React Native, developed by
            Facebook in 2015, and Flutter, developed by Google in 2018. We will
            do a simple comparison between the 2 different tools, before coming
            to a conclusion that using Flutter to develop a mobile scanner app
            that simulates the scanners in an actual implementation is the best
            option.
          </p>
          <div className="case">Comparison (Hybrid vs Native app)</div>
          <p>
            A native app is a software application built in a specific
            programming language, for the specific device platform, either iOS
            or Android[10], or both in the case of cross-platform. In this case,
            a native app is able to work offline, and offer a faster, more
            reliable and more responsive experience to users. However, native
            app development is more expensive and takes more time. We will
            discuss other factors in the section below when we compare between
            native, hybrid and web apps.
            <br />
            <br />
            Meanwhile, a hybrid app is installed like a native app, but it runs
            as a web app built with JavaScript, HTML, and CSS, and runs in a
            simplified browser in the app, called webview. Hybrid apps are
            easier to build, and take less time and resources, but suffer on
            performance as they are bottlenecked by the webview, which is
            responsible for the UI and JavaScript code.
            <br />
            <br />
            As mentioned, the mobile scanner is a proof of concept, and we are
            not using an app in actual implementation, hence we want the option
            that is the fastest and cheapest to build. We chose to build a
            hybrid app.
          </p>
          ...
          <p>
            ...
            uses JavaScript, and uses the same design as React[11]. It has great
          ...
          <p>
            We can develop our client application in 3 ways: native app, hybrid
            app, or web app. A native app is able to work offline, and provides
            more speed and functionalities as they have more access to system
            resources. However, they are more costly, as they have to be
            designed and built from scratch to accommodate different platforms
            and to maintain after deployment.[12]
            <br />
            <br />
            Web apps boast ease of development and maintenance, and they do not
            need to be downloaded - they function on browsers, which puts web
            apps as the cheapest to build. The shortfalls are that they do not
            work offline, have fewer features, and execute functions slower than
            mobile apps.
            <br />
            <br />
            Hybrid apps, as mentioned in the previous comparison, are a mix of
            both web and native apps. They are able to fully utilise the
            devices’ resources as they are installed like a native app, while
            also cheaper to build as they actually run on webviews. But, they
            have performance issues as they are reliant on the webview to
            display their functionalities.
            <br />
            <br />
            Our application needs to be used by the entire staff within the
            hospital, which also means we have to select the approach with the
            highest user coverage, using the least amount of resources. A web
            app is the cheapest and is the fastest to build, and considering the
            short amount of time we have, we decided to go with a web app.
          </p>
          <div className="case">
          ...
          <p>
            ...
            <br />
            <br />
            Our team have had experience in building React apps before, and are
            familiar with the libraries that are needed for an app such as this.
            Despite the fact that React is not the easiest framework to learn,
            its ease of integration with other frameworks makes up for it, hence
            we have decided to go with it. We believe in the short few months of
            time that we have to develop a system that is rather complex, we
          ...
          <div className="case">
            Comparison (Server-side frameworks - Django vs ExpressJS + NodeJS)
          </div>
          <p>
            Django[15] is a high-level Python web framework that allows rapid
            development to facilitate web developers in building applications
            quickly. It provides better performance due to an inbuilt template
            system and has better cost-efficiency due to being more dynamic.
            <br />
            <br />
            ExpressJS[16] is a backend web app framework for NodeJS, and is a
            layer developed on top of NodeJS that aids administering routes and
            the server. NodeJS is a JavaScript runtime environment that caters
            to structuring backend and server side development. While it suffers
            from lower performance and being less cost-effective, NodeJS is by
            far the most efficient and productive as it is the only server-side
            framework that uses JavaScript. This thus gives the entire
            development all the pros of full stack JavaScript development, such
            as code sharing and reuse, and increased speed and performance. This
            consequently provides us with more time for other parts of
            development, while at the same time building it quickly and
            reliably. Hence, we chose NodeJS.
          </p>
          <div className="case">
            Comparison (Databases - NoSQL (MongoDB) vs SQL)
          </div>
          <p>
            NoSQL are document databases that operate as non-relational and
            unstructured databases.[17] In MongoDB, a NoSQL database, individual
            information is stored as documents which are collections of fields,
            known as JSON files, and allow for dynamic data processing and more
            flexibility as each collection need not have the same set of fields.
            It also allows for horizontal scaling, by means of adding more
            servers and expanding storage. Time series collections are present
            in MongoDB which stores sequences of measurements over a period of
            time, which increases query efficiency.
            <br />
            <br />
      ...
      <div className="content-block">
        ...
        <div className="text">
          ...
          <ol>
            ...
            <li>
              "Native, Web or Hybrid Apps? What's The Difference?", MobiLoud,
              2022. [Online]. Available:
              https://www.mobiloud.com/blog/native-web-or-hybrid-apps.
              [Accessed: 29- Mar- 2022].{" "}
            </li>
            <li>
              "Flutter vs React Native – What to Choose in 2022?", Droids On
              Roids, 2022. [Online]. Available:
              https://www.thedroidsonroids.com/blog/flutter-vs-react-native-what-to-choose-in-2021#f10.
              [Accessed: 28- Mar- 2022].
            </li>
            <li>
              "Mobile Apps vs Web — Apps: Which is the Better Option?", Medium,
              2022. [Online]. Available:
            ...
            <li>
              ...
              CodeinWP, 2022. [Online]. Available:
              https://www.codeinwp.com/blog/angular-vs-vue-vs-react/#who-wins.
              [Accessed: 29- Mar- 2022].
            </li>
            <li>
            ...
            <li>
              ...
              Monocubed, 2022. [Online]. Available:
              https://www.monocubed.com/blog/django-vs-node-js/#:~:text=The%20main%20difference%20between%20Django,on%20client%2Dside%20web%20applications.
              [Accessed: 29- Mar- 2022].
            </li>
            <li>
              "Django vs Express: 2 Best Web Frameworks Compared in 2022",
              Monocubed, 2022. [Online]. Available:
              https://www.monocubed.com/blog/django-vs-express/#:~:text=In%20Django%20vs%20Express.,easily%20negated%20by%20experienced%20developers.
              [Accessed: 29- Mar- 2022].
            </li>
            <li>
              A. Sharma, R. Verma and M. Gaikwad, "MongoDB vs SQL Databases: 4
              Comprehensive Aspects", Learn | Hevo, 2022. [Online]. Available:
              https://hevodata.com/learn/mongodb-vs-sql/. [Accessed: 29- Mar-
              2022].
            </li>
            <li>
              Mongodb.com, 2022. [Online]. Available:
